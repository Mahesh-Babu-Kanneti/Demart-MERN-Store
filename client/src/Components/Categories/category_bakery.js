...
useEffect(()=>{
            ...
            <Toaster
                ...
                <div style={{ width: "auto" }}>
                    ...
                    <Card style={{ border: "none", marginTop: "-15px", borderRadius: "0px" }}>
                        <Card.Body style={{ margin: "10px 0px 0px 15px" }}> <h5> Bakery & Snacks </h5>  </Card.Body>
                    </Card>
 ...
 {load ? <Loader/> : <>
                    ...
                    {bakeryProducts.filter(li=>li.productCategory==='backery_snacks').map(list => <div style={{ display: "inline-flex" }}  key={list._id}>
