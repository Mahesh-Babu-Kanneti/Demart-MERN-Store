            ...
            <Toaster
                ...
                <div style={{ width: "auto" }}>
                    ...
                    <Card style={{ border: "none", marginTop: "-15px", borderRadius: "0px" }}>
                        <Card.Body style={{ margin: "10px 0px 0px 15px" }}> <h5> Health & Wellness </h5>  </Card.Body>
                    </Card>
...
{load ? <Loader/> : <>
                    ...
                    {healthProducts.filter(li=>li.productCategory==='health_wellness').map(list => <div style={{ display: "inline-flex" }}  key={list._id}>
