               ...
               <br /><br /><br /><br /><br />
                ...
                <div style={{ width: "auto" }}>
                    ...
                    <Card style={{ border: "none", marginTop: "-15px", borderRadius: "0px" }}>
                        <Card.Body style={{ margin: "10px 0px 0px 15px" }}> <h5> Dairy & Frozen Foods </h5>  </Card.Body>
                    </Card>
...
{load ? <Loader/> : <>
                    ...
                    {dairyProducts.filter(li=>li.productCategory==='dairy_frozenfoods').map(list => <div style={{ display: "inline-flex" }}  key={list._id}>
